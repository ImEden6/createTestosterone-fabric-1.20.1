...
import net.mervyn.testosterone.blocks.johnRock;
...
public class johnScene {
    public static void john_bell(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        BlockPos obToJohn1 = util.grid().at(rand.nextInt(4) + 4, 1, 1);
        BlockPos obToJohn2 = util.grid().at(rand.nextInt(2) + 1, 1, 4);
        BlockPos obToJohn3 = util.grid().at(rand.nextInt(3) + 3, 1, 6);

        BlockPos obToJohn4 = util.grid().at(rand.nextInt(4) + 4, 1, 3);
        BlockPos obToJohn5 = util.grid().at(rand.nextInt(2) + 1, 1, 2);
        BlockPos obToJohn6 = util.grid().at(rand.nextInt(2) + 1, 1, 7);
    ...
    public static void john_active_inactive(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.special().moveParrot(birb, util.vector().of(0, 0, -3.00), 1000);
		scene.idle(70);
    }
}
